...
{
    public static Regex RaceCodeParser = new(@"c(?'racecode'\d{4})");
    ...
    public static partial class Monster
    {
        ...
        {
            public static Regex Regex = new(@"chara/monster/m(?'monster'\d{4})/obj/body/b(?'id'\d{4})/b\k'id'\.imc");
        ...
        {
            public static Regex Regex = new(@"chara/monster/m(?'monster'\d{4})/obj/body/b(?'id'\d{4})/model/m\k'monster'b\k'id'\.mdl");
        ...
        {
            public static Regex Regex =new(@"chara/monster/m(?'monster'\d{4})/obj/body/b(?'id'\d{4})/material/v(?'variant'\d{4})/mt_m\k'monster'b\k'id'_[a-z]+\.mtrl");
        ...
        {
            public static Regex Regex = new(@"chara/monster/m(?'monster'\d{4})/obj/body/b(?'id'\d{4})/texture/v(?'variant'\d{2})_m\k'monster'b\k'id'(_[a-z])?_[a-z]\.tex");
    ...
    public static partial class Weapon
    {
        public static partial class Imc
        {
            public static Regex Regex = new(@"chara/weapon/w(?'id'\d{4})/obj/body/b(?'weapon'\d{4})/b\k'weapon'\.imc");
        ...
        public static partial class Mdl
        {
            public static Regex Regex = new(@"chara/weapon/w(?'id'\d{4})/obj/body/b(?'weapon'\d{4})/model/w\k'id'b\k'weapon'\.mdl");
        ...
        public static partial class Mtrl
        {
            public static Regex Regex = new(@"chara/weapon/w(?'id'\d{4})/obj/body/b(?'weapon'\d{4})/material/v(?'variant'\d{4})/mt_w\k'id'b\k'weapon'_[a-z]+\.mtrl");
        ...
        public static partial class Tex
        {
            public static Regex Regex = new(@"chara/weapon/w(?'id'\d{4})/obj/body/b(?'weapon'\d{4})/texture/v(?'variant'\d{2})_w\k'id'b\k'weapon'(_[a-z])?_[a-z]\.tex");
    ...
    public static partial class DemiHuman
    {
        public static partial class Imc
        {
            public static Regex Regex = new(@"chara/demihuman/d(?'id'\d{4})/obj/equipment/e(?'equip'\d{4})/e\k'equip'\.imc");
        ...
        public static partial class Mdl
        {
            public static Regex Regex = new(@"chara/demihuman/d(?'id'\d{4})/obj/equipment/e(?'equip'\d{4})/model/d\k'id'e\k'equip'_(?'slot'[a-z]{3})\.mdl");
        ...
        public static partial class Mtrl
        {
            public static Regex Regex = new(@"chara/demihuman/d(?'id'\d{4})/obj/equipment/e(?'equip'\d{4})/material/v(?'variant'\d{4})/mt_d\k'id'e\k'equip'_(?'slot'[a-z]{3})_[a-z]+\.mtrl");
        ...
        public static partial class Tex
        {
            public static Regex Regex = new(@"chara/demihuman/d(?'id'\d{4})/obj/equipment/e(?'equip'\d{4})/texture/v(?'variant'\d{2})_d\k'id'e\k'equip'_(?'slot'[a-z]{3})(_[a-z])?_[a-z]\.tex");
    ...
    public static partial class Equipment
    {
        public static partial class Imc
        {
            public static Regex Regex = new(@"chara/equipment/e(?'id'\d{4})/e\k'id'\.imc");
        ...
        public static partial class Mdl
        {
            public static Regex Regex = new(@"chara/equipment/e(?'id'\d{4})/model/c(?'race'\d{4})e\k'id'_(?'slot'[a-z]{3})\.mdl");
        ...
        public static partial class Mtrl
        {
            public static Regex Regex = new(@"chara/equipment/e(?'id'\d{4})/material/v(?'variant'\d{4})/mt_c(?'race'\d{4})e\k'id'_(?'slot'[a-z]{3})_[a-z]+\.mtrl");
        ...
        public static partial class Tex
        {
            public static Regex Regex = new(@"chara/equipment/e(?'id'\d{4})/texture/v(?'variant'\d{2})_c(?'race'\d{4})e\k'id'_(?'slot'[a-z]{3})(_[a-z])?_[a-z]\.tex");
        ...
        {
            public static Regex Regex = new(@"chara/equipment/e(?'id'\d{4})/vfx/eff/ve(?'variant'\d{4})\.avfx");
        ...
        {
            public static Regex Regex = new(@"chara/common/texture/decal_equip/-decal_(?'decalId'\d{3})\.tex");
    ...
    public static partial class Accessory
    {
        public static partial class Imc
        {
            public static Regex Regex = new(@"chara/accessory/a(?'id'\d{4})/a\k'id'\.imc");
        ...
        public static partial class Mdl
        {
            public static Regex Regex = new(@"chara/accessory/a(?'id'\d{4})/model/c(?'race'\d{4})a\k'id'_(?'slot'[a-z]{3})\.mdl");
        ...
        public static partial class Mtrl
        {
            public static Regex Regex = new(@"chara/accessory/a(?'id'\d{4})/material/v(?'variant'\d{4})/mt_c(?'race'\d{4})a\k'id'_(?'slot'[a-z]{3})_[a-z]+\.mtrl");
        ...
        public static partial class Tex
        {
            public static Regex Regex = new(@"chara/accessory/a(?'id'\d{4})/texture/v(?'variant'\d{2})_c(?'race'\d{4})a\k'id'_(?'slot'[a-z]{3})(_[a-z])?_[a-z]\.tex");
    ...
    public static partial class Character
    {
        public static partial class Mdl
        {
            public static Regex Regex = new(@"chara/human/c(?'race'\d{4})/obj/(?'type'[a-z]+)/(?'typeabr'[a-z])(?'id'\d{4})/model/c\k'race'\k'typeabr'\k'id'_(?'slot'[a-z]{3})\.mdl");
        ...
        public static partial class Mtrl
        {
            public static Regex Regex = new(@"chara/human/c(?'race'\d{4})/obj/(?'type'[a-z]+)/(?'typeabr'[a-z])(?'id'\d{4})/material(/v(?'variant'\d{4}))?/mt_c\k'race'\k'typeabr'\k'id'(_(?'slot'[a-z]{3}))?_[a-z]+\.mtrl");
        ...
        public static partial class Tex
        {
            public static Regex Regex = new(@"chara/human/c(?'race'\d{4})/obj/(?'type'[a-z]+)/(?'typeabr'[a-z])(?'id'\d{4})/texture/(?'minus'(--)?)(v(?'variant'\d{2})_)?c\k'race'\k'typeabr'\k'id'(_(?'slot'[a-z]{3}))?(_[a-z])?_[a-z]\.tex");
            ...
            public static Regex CatchlightRegex = new(@"chara/common/texture/(?'catchlight'catchlight)(.*)\.tex");

            public static Regex SkinRegex = new(@"chara/common/texture/skin(?'skin'.*)\.tex");

            public static Regex DecalRegex = new(@"chara/common/texture/decal_(?'location'[a-z]+)/[-_]?decal_(?'id'\d+).tex");

            public static Regex FolderRegex = new(@"chara/human/c(?'race'\d{4})/obj/(?'type'[a-z]+)/(?'typeabr'[a-z])(?'id'\d{4})/texture");
        }
    }

    public static partial class Icon
    {
        public static Regex Regex = new(@"ui/icon/(?'group'\d*)(/(?'lang'[a-z]{2}))?(/(?'hq'hq))?/(?'id'\d*)(?'hr'_hr1)?\.tex");
    }

    public static partial class Map
    {
        public static Regex Regex = new(@"ui/map/(?'id'[a-z0-9]{4})/(?'variant'\d{2})/\k'id'\k'variant'(?'suffix'[a-z])?(_[a-z])?\.tex");
    }

    public static partial class Font
    {
        public static Regex Regex = new(@"common/font/(?'fontname'.*)_(?'id'\d\d)(_lobby)?\.fdt");
    }

    public static partial class Vfx
    {
        public static Regex Tmb = new(@"chara[\/]action[\/](?'key'[^\s]+?)\.tmb", RegexOptions.IgnoreCase);

        public static Regex Pap = new(@"chara[\/]human[\/]c0101[\/]animation[\/]a0001[\/][^\s]+?[\/](?'key'[^\s]+?)\.pap", RegexOptions.IgnoreCase);
    }
